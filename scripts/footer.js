      ...
      '<div class="footer-top">' +
        ...
        '<div class="footer-col">' +
          ...
          '<ul class="footer-contact">' +
            ...
            '<li><img src="/img/whatsapp.svg" alt="" class="footer-icon" /><a href="https://wa.me/995595223333" target="_blank" rel="noopener noreferrer">WhatsApp</a></li>' +
  ...
  if (footerMobile) {
    footerMobile.innerHTML =
      '<ul class="footer-mobile-links">' +
        ...
        '<li><a href="https://wa.me/995595223333" target="_blank" rel="noopener noreferrer"><img src="/img/whatsapp.svg" alt="WhatsApp" /></a></li>' +
